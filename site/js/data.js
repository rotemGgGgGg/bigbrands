...
const _PRODUCTS = [
  ...
  { id:"u1", brand:"Lenovo", series:"T", name:"Lenovo ThinkPad T14 Gen 2", category:"יד שנייה", status:"stock", price:1590, badge:"מחודש",
  ...
  { id:"u2", brand:"Lenovo", series:"X", name:"Lenovo ThinkPad X13 Gen 2", category:"יד שנייה", status:"stock", price:1632, badge:"מחודש",
  ...
  { id:"u3", brand:"Lenovo", series:"T", name:"Lenovo ThinkPad T14 Gen 1", category:"יד שנייה", status:"stock", price:1399, badge:"מחודש",
  ...
  { id:"u4", brand:"Lenovo", series:"P", name:"Lenovo ThinkPad P14s Gen 2", category:"יד שנייה", status:"stock", price:2800, badge:"מחודש",
  ...
  { id:"u5", brand:"Lenovo", series:"L", name:"Lenovo ThinkPad L14 Gen 1", category:"יד שנייה", status:"stock", price:1190, badge:"מחודש",
  ...
  { id:"u6", brand:"Lenovo", series:"ThinkCentre", name:"Lenovo ThinkCentre M900 (מחשב נייח)", category:"יד שנייה", status:"stock", price:700, badge:"מחודש",
  ...
  { id:"u7", brand:"Dell", name:"Dell Latitude 5430 (Core i7)", category:"יד שנייה", status:"stock", price:2299, badge:"מחודש",
  ...
  { id:"u8", brand:"Lenovo", series:"X", name:"Lenovo ThinkPad X13 Gen 2 (FHD+)", category:"יד שנייה", status:"stock", price:1650, badge:"מחודש",
  ...
  { id:"u9", brand:"Lenovo", series:"ThinkCentre", name:"Lenovo ThinkCentre M93p (Mini)", category:"יד שנייה", status:"stock", price:550, badge:"מחודש",
  ...
  { id:"u10", brand:"HP", name:"HP EliteDesk 800 G2 Mini", category:"יד שנייה", status:"stock", price:680, badge:"מחודש",
  ...
  { id:"u11", brand:"Lenovo", series:"T", name:"Lenovo ThinkPad T14 Gen 2 (Win11 Pro)", category:"יד שנייה", status:"stock", price:1537, wasPrice:1618, badge:"מחודש",
  ...
  { id:"u14", brand:"Dell", name:"Dell OptiPlex 7060 Micro (i5 דור 8)", category:"יד שנייה", status:"stock", price:1000, wasPrice:1280, badge:"מחודש",
    desc:`מחשב נייח זעיר מחודש של Dell מסדרת OptiPlex 7060 Micro — קומפקטי במיוחד (1.4 ליטר), שקט וחסכוני באנרגיה. אידיאלי למשרד ולעבודה מהבית במחיר שווה.`,
    specs:`Micro PC (1.4 ליטר) | Intel Core i5 דור 8 | 16GB DDR4 | 240GB SSD | Intel UHD Graphics 630 | Windows 11 Pro | אחריות ביג ברנדס 12 חודשים`,
    image:"assets/products/u14.jpg" },
  { id:"u13", brand:"HP", name:"HP EliteDesk 800 G4 DM Mini (i5-8500)", category:"יד שנייה", status:"stock", price:990, wasPrice:1390, badge:"מחודש",
    desc:`מחשב נייח מיני מחודש של HP — קומפקטי במיוחד, שקט וחסכוני באנרגיה. אידיאלי למשרד, לעבודה מהבית ולעמדות עבודה עסקיות במחיר משתלם.`,
    specs:`Mini PC (DeskMini) | Intel Core i5-8500 (6 ליבות) | 16GB DDR4 | 256GB NVMe SSD | Intel UHD Graphics | תמיכה בשני מסכים | Windows 11 Pro | אחריות ביג ברנדס 12 חודשים`,
    image:"assets/products/u13.jpg" },
  { id:"u12", brand:"HP", name:"HP EliteDesk 800 G6 SFF (i5 דור 10)", category:"יד שנייה", status:"stock", price:1880, wasPrice:2490, badge:"מחודש",
    desc:`מחשב נייח עסקי מחודש של HP מסדרת EliteDesk 800 — שקט, קומפקטי ואמין, אידיאלי למשרד ולעבודה מהבית. במחיר מבצע חד-פעמי, משתלם במיוחד לרכישה עכשיו.`,
  ...
  { id:"b1", brand:"HP", name:"באנדל מקצועי HP — מחשב + מסך + מקלדת ועכבר", category:"באנדלים", status:"stock", price:1075, wasPrice:1265, badge:"חיסכון 15%",
    ...
    image:"assets/products/b1lockscreen.png" },
  { id:"b2", brand:"Lenovo", name:"באנדל לבית ולמשרד — מחשב + מסך + מקלדת ועכבר", category:"באנדלים", status:"stock", price:1120, wasPrice:1135, badge:"חיסכון 12%",
    ...
    image:"assets/products/b2lockscreen.png" },
