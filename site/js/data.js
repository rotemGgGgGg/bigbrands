...
const _PRODUCTS = [
  ...
  { id:"u1", brand:"Lenovo", name:"Lenovo ThinkPad T14 Gen 2", category:"יד שנייה", status:"stock", price:1400, badge:"",
  ...
  { id:"u2", brand:"Lenovo", name:"Lenovo ThinkPad X13 Gen 2", category:"יד שנייה", status:"stock", price:1632, badge:"",
    specs:`13.3" IPS | Intel Core דור 11 | 16GB RAM | 256GB SSD | ~1.24 ק"ג | USB-C | סוללה עד 11 שעות`,
    image:_IMG+"1777018645588_x8a6jds05if.png" },
  { id:"u3", brand:"Lenovo", name:"Lenovo ThinkPad T14 Gen 1", category:"יד שנייה", status:"stock", price:1188, wasPrice:1250, badge:"מבצע",
    specs:`14" FHD IPS | Intel Core דור 10 | 16GB RAM | 256GB SSD | Thunderbolt 3 | סוללה עד 13 שעות | Win10 Pro`,
    image:_IMG+"1777018513469_vlq03kow2r.jpg" },
  { id:"u4", brand:"Lenovo", name:"Lenovo ThinkPad P14s Gen 2", category:"יד שנייה", status:"stock", price:2800, badge:"",
  ...
  { id:"u5", brand:"Lenovo", name:"Lenovo ThinkPad L14 Gen 1", category:"יד שנייה", status:"stock", price:1300, badge:"",
    specs:`14" FHD | Intel i5-10210U | 8GB DDR4 | 256GB NVMe | USB-C | HDMI | Win10 Pro`,
    image:_IMG+"1776944007661_nfx66f8ajmd.png" },
  { id:"u6", brand:"Lenovo", name:"Lenovo ThinkCentre M900 (מחשב נייח)", category:"יד שנייה", status:"stock", price:700, badge:"",
  ...
  { id:"u7", brand:"Dell", name:"Dell Latitude 5420 (Core i7)", category:"יד שנייה", status:"stock", price:2500, badge:"",
    specs:`14" FHD (1920x1200) | Intel i7 דור 11 | 16GB DDR4 | 256GB NVMe | Iris Xe | Thunderbolt 4 | מקלדת עברית`,
    image:_IMG+"1775678180919_sz0y7v2qw.webp" },
  { id:"u8", brand:"Lenovo", name:"Lenovo ThinkPad X13 Gen 2 (FHD+)", category:"יד שנייה", status:"stock", price:1650, badge:"",
    specs:`IPS FHD (1920x1200) | 1.27 ק"ג | SSD NVMe | WiFi 6 | Thunderbolt 4 | קורא טביעת אצבע | סוללה עד 13 שעות`,
    image:_IMG+"1775677691222_ge5tve2s5md.png" },
  { id:"u9", brand:"Lenovo", name:"Lenovo ThinkCentre M93p (Mini)", category:"יד שנייה", status:"stock", price:550, badge:"",
  ...
  { id:"u10", brand:"HP", name:"HP EliteDesk 800 G2 Mini", category:"יד שנייה", status:"stock", price:680, badge:"",
    specs:`מחשב נייח קומפקטי | Intel i5 דור 6 | עד 16GB RAM | עד 512GB SSD | HDMI | 4×USB 3.0 | Win10/11`,
    image:_IMG+"1775677751909_yb5zxlbvsxl.jpg" },
  { id:"u11", brand:"Lenovo", name:"Lenovo ThinkPad T14 Gen 2 (Win11 Pro)", category:"יד שנייה", status:"stock", price:1537, wasPrice:1618, badge:"מבצע",
  ...
  { id:"b2", brand:"OS-TECH", name:"באנדל לבית ולמשרד — מחשב + מסך + מקלדת ועכבר", category:"באנדלים", status:"stock", price:999, wasPrice:1135, badge:"חיסכון 12%",
...
window.SITE_DATA = {
  ...
  heroSlides: [
    ...
    },
    {
      ...
      fallbackImage: "assets/banners/asus-expertbook.png",
      alt: "מחשבים ניידים מובילים — חדשים ומחודשים",
      link: "products.html",
    },
  ],
  ...
  partners: [
    ...
    },
    {
      ...
      person: "[שם] · סמנכ\"ל/ית טכנולוגיות (CTO)",
    },
    {
      name: "ePost",
      logo: "Post",
      ...
      person: "[שם] · מנהל/ת רכש ולוגיסטיקה",
    },
  ],
