...
const _PRODUCTS = [
  ...
  { id:"u13", brand:"HP", name:"HP EliteDesk 800 G4 DM Mini (i5-8500)", category:"יד שנייה", status:"stock", price:990, wasPrice:1390, badge:"מבצע",
    desc:`מחשב נייח מיני מחודש של HP מסדרת EliteDesk 800 G4 DM — קומפקטי במיוחד, שקט וחסכוני באנרגיה. מעבד i5-8500 עם 6 ליבות, 16GB RAM ו-SSD NVMe 512GB. אידיאלי למשרד, לעבודה מהבית ולעמדות עבודה עסקיות. תומך בשני מסכים.`,
    specs:`Mini PC (DeskMini) | Intel Core i5-8500 (6 ליבות) | 16GB DDR4 | 512GB NVMe SSD | Intel UHD Graphics | תמיכה בשני מסכים | Windows 11 Pro | אחריות ביג ברנדס 12 חודשים`,
